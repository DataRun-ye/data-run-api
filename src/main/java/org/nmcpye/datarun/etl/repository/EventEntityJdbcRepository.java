...
public class EventEntityJdbcRepository {
    ...
    public void upsertEventEntity(EventDto eventDto) {
        ...
        String sql = ""
            ...
            + "event_id, instance_key, event_type, submission_uid, submission_id, assignment_uid, activity_uid, "
            + "org_unit_uid, team_uid, template_uid, submission_creation_time, start_time, last_seen, "
            ...
            + "VALUES ("
            + ":eventUid, :instanceKey, :eventType, :submissionUid, :submissionId, :assignmentUid, :activityUid, "
            + ":orgUnitUid, :teamUid, :templateUid, :submissionCreationTime, :startTime, :lastSeen,"
