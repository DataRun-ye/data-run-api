...
public class OrganizationUnit implements Serializable {
    ...
    public OrganizationUnit id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public OrganizationUnit ouPath(String ouPath) {
    ...
    public OrganizationUnit parent(String parent) {
    ...
    public OrganizationUnit parentCode(String parentCode) {
    ...
    public OrganizationUnit level(OuLevel ouLevel) {
    ...
    public boolean equals(Object o) {
        ...
        return getId() != null && getId().equals(((OrganizationUnit) o).getId());
    }
