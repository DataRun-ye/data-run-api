...
public class MetaPermission extends BasePermission {
    ...
    public static final Permission READ = new MetaPermission(1 << 0, 'R');
    // bit 1 → mask = 2, code = 'W'
    public static final Permission WRITE = new MetaPermission(1 << 1, 'W');
    // bit 2 → mask = 4, code = 'C'
    public static final Permission UPDATE = new MetaPermission(1 << 2, 'C');
    // bit 4 → mask = 8, code = 'D'
    public static final Permission DELETE = new MetaPermission(1 << 3, 'D');
    // bit 8 → mask = 16, code = 'A' (admin)
    public static final Permission MANAGE = new MetaPermission(1 << 4, 'A');
