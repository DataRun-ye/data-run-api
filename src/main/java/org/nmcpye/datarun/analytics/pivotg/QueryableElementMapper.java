...
public interface QueryableElementMapper {
...
//    @Mapping(target = "label", source = "label")
    ...
    List<QueryableElement> toQueryableElement(List<DataElementRecord> dataElements);
...
//    @Mapping(target = "label", source = "displayLabel")
    ...
    List<QueryableElement> toQueryableElementsFromConfigs(List<ElementTemplateConfigRecord> configs);
