...
// */
//@Entity
//@Table(name = "d_task", uniqueConstraints = {
...
//    private Set<DTask> children = new HashSet<>();
//
//    @Column(name = "path")
//    private String path;
//
...
//    }
//
//    public DTask createdBy(String createdBy) {
//        this.setCreatedBy(createdBy);
//        return this;
//    }
//
//    public DTask createdDate(Instant createdDate) {
//        this.setCreatedDate(createdDate);
//        return this;
//    }
//
//    public DTask lastModifiedBy(String lastModifiedBy) {
//        this.setLastModifiedBy(lastModifiedBy);
//        return this;
//    }
//
//    public DTask lastModifiedDate(Instant lastModifiedDate) {
...
//    }
//
//    public DTask activity(Activity activity) {
...
//    }
//
//    public DTask organisationUnit(OrgUnit orgUnit) {
...
//     */
//    public String getParentGraph(Collection<DTask> roots) {
...
//     * activities.
//     */
//    public static Map<String, String> getParentGraphMap(List<DTask> activities, Collection<DTask> roots) {
//        Map<String, String> map = new HashMap<>();
//
//        if (activities != null) {
//            for (DTask assignment : activities) {
...
//    }
//
//    public Set<DTask> getChildren() {
//        return children;
//    }
//
//    public void setChildren(Set<DTask> children) {
...
//     * queries. For application use see {@link DTask#getLevel()} which
...
//    }
//
//    public DTask hierarchyLevel(Integer hierarchyLevel) {
...
//    public List<DTask> getAncestors() {
//        List<DTask> activities = new ArrayList<>();
//        Set<DTask> visitedActivities = new HashSet<>();
//
//        DTask assignment = parent;
//
...
//     * @param roots the root activities, if null using real roots.
//     */
//    public List<DTask> getAncestors(Collection<DTask> roots) {
//        List<DTask> activities = new ArrayList<>();
//        DTask assignment = parent;
//
//        while (assignment != null) {
...
//    }
//
//    public boolean isDescendant(DTask ancestor) {
//        if (ancestor == null) {
//            return false;
//        }
//
...
//
//    @JsonIgnore
//    public boolean isDescendant(Set<DTask> ancestors) {
//        if (ancestors == null || ancestors.isEmpty()) {
//            return false;
//        }
//        Set<String> ancestorsUid = ancestors.stream().map(DTask::getUid).collect(Collectors.toSet());
//
//        DTask unit = this;
//
//        while (unit != null) {
...
//    }
//
//    public DTask getParent() {
//        return parent;
//    }
//
//    public void setParent(DTask parent) {
//        this.parent = parent;
//    }
//
//    @Override
