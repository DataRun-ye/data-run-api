...
@Primary
@Transactional
public class OrgUnitGroupSetServiceImpl
    extends IdentifiableRelationalServiceImpl<OrgUnitGroupSet>
    implements OrgUnitGroupSetService {

    private final OrgUnitGroupSetRelationalRepository repository;
    private final OrgUnitGroupRelationalRepository orgUnitGroupRepository;

    public OrgUnitGroupSetServiceImpl(OrgUnitGroupSetRelationalRepository repository,
                                      OrgUnitGroupRelationalRepository orgUnitGroupRepository,
