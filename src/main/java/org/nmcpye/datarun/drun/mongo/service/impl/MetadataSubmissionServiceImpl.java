...
public class MetadataSubmissionServiceImpl
    ...
    public MetadataSubmissionServiceImpl(
        ...
        OrgUnitRelationalRepositoryCustom orgUnitRelationalRepositoryCustom, MongoTemplate mongoTemplate, SequenceGeneratorService sequenceGeneratorService) {
        super(repository);
    ...
    @Override
    public Page<MetadataSubmission> findAllByUser(Pageable pageable) {
        if (SecurityUtils.hasCurrentUserAnyOfAuthorities(AuthoritiesConstants.ADMIN)) {
