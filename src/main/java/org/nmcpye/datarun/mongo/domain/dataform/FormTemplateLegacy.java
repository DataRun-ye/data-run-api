...
public class FormTemplateLegacy
    ...
    public FormTemplateLegacy versionNumber(Integer currentVersion) {
        setVersionNumber(currentVersion);
        return this;
    }

    public FormTemplateLegacy id(String id) {
        setId(id);
        return this;
    }

    public FormTemplateLegacy uid(String uid) {
        setUid(uid);
        return this;
    }

    public FormTemplateLegacy formVersion(String formVersion) {
...
//    }
    ...
    public boolean equals(Object o) {
        if (!(o instanceof FormTemplateLegacy that)) return false;
