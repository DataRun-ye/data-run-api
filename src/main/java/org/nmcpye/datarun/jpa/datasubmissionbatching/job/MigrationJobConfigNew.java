...
//@Configuration
//@Slf4j
//public class MigrationJobConfigNew {
//
...
//
//    @Bean
//    public Job mongoToPostgresJob(JobRepository jobRepository, @Qualifier("mongoToPgStep") Step migrationStep) {
...
//
//    @Bean
//    public Job postgresToOutboxJob(JobRepository jobRepository, @Qualifier("postgresToOutboxStep") Step postgresToOutboxStep) {
