...
public class TemplateFieldCache {
    private final ConcurrentMap<String, List<ElementTemplate>> map = new ConcurrentHashMap<>();

    private String key(String templateId, String versionId) {
        return templateId + ":" + versionId;
    }

    public void put(String templateId, String versionId, List<ElementTemplate> fields) {
    ...
    public List<ElementTemplate> get(String templateId, String versionId) {
