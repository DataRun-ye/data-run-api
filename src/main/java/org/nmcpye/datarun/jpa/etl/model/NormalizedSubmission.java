...
public class NormalizedSubmission {
    ...
    public static NormalizedSubmission initialValueBuilder(DataFormSubmission submission,
                                                           CurrentUserDetails currentUser) {
        final var currentUserLogin = currentUser != null ? currentUser.getUsername() : null;
        final NormalizedSubmission.NormalizedSubmissionBuilder nsBuilder = NormalizedSubmission.builder()
