...
class ReferenceAssignmentScopeGuardTest {
    ...
    @Test
    void referenceAssignmentKeepsOriginalActivityAndOrgUnit() {
        referenceEnabled();
    ...
    @Test
    void referenceAssignmentRejectsRemovingReferenceForm() {
        referenceEnabled();
    ...
    void ordinaryAssignmentKeepsExistingUpdateBehavior() {
        when(capabilityService.findReferenceTemplateUidsAcrossVersions(
            assignment.getForms()))
            .thenReturn(Set.of());
