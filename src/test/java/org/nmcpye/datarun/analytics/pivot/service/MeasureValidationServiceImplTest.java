...
class MeasureValidationServiceImplTest {
    ...
    DataElementService deRepo = Mockito.mock(DataElementService.class);
    ...
    @BeforeEach
    void setUp() {
        svc = new MeasureValidationServiceImpl(pivotMetadataService, fieldMapper, etcRepo, deRepo, dsl);
    }
